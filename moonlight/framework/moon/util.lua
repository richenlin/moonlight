...
local moonvars = require("moon.vars");

module('moon.util', package.seeall);
...
function get_config(key, default)
    ...
    if not issub then -- main app
        ...
        local app_conf=moonvars.get(APP_NAME,"APP_CONFIG");
    ...
    local subapps=moonvars.get(APP_NAME,"APP_CONFIG").subapps or {};
...
function is_subapp(__call_frame_level)
    ...
    local main_app = ngx.var.MOON_APP_PATH;
